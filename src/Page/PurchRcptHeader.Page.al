page 50311 PurchRcptHeader
{
    ...
    [ServiceEnabled]
    procedure Email(var ActionContext: WebServiceActionContext)
    begin
        GlobalLanguage(1043);
    ...
    local procedure SetActionResponse(var ActionContext: WebServiceActionContext; SystemId: Guid)
    var
    begin
    ...
    SendAsEmail: Boolean;
    UseEMailForPurchReceipt: Boolean)
    var
    ...
    begin
        ...
        if SendAsEmail then begin
            ...
            ReportSelections.SendEmailToVendor(ReportSelections.Usage::"P.Receipt".AsInteger(), PurchRcptHeader, PurchRcptHeader."No.", DocName, false, '')
        end
        else
